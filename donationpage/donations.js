document.addEventListener('DOMContentLoaded', function() {
    function fetchDonationData() {
        fetch('http://localhost/savinghope/donationpage/get_donations.php')
            .then(response => {
                if (!response.ok) {
    ...
    function createDonationCard(donation) {
        ...
        const imageUrl = donation.pic_url ? 'http://localhost/savinghope/' + donation.pic_url : 'http://localhost/savinghope/images/placeholder.jpg';
